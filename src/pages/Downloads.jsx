      ...
      {downloadSections.map((section, sectionIdx) => (
        <section key={sectionIdx} className={sectionIdx % 2 === 0 ? '' : 'bg-gray-50'}>
          <div className="max-w-7xl mx-auto px-4 py-16">
            <h2 className="text-3xl font-bold text-[#3D3C42] mb-12">{section.title}</h2>
                ...
                <Card key={idx} className="hover:border-blue-300 border border-transparent">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-grow">
                      <h3 className="text-lg font-bold text-[#3D3C42] mb-2">{item.name}</h3>
                      <p className="text-sm text-gray-600 mb-4">{item.desc}</p>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-gray-500">{item.size}</span>
                        <button className="text-[#7F5283] hover:text-blue-900 font-semibold text-sm flex items-center gap-1">
                          ⬇️ Download
                        </button>
                      </div>
                    </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card>
            ...
            <h3 className="text-lg font-bold text-[#3D3C42] mb-2">Visa Application Guide</h3>
          ...
          <Card>
            ...
            <h3 className="text-lg font-bold text-[#3D3C42] mb-2">Campus Orientation</h3>
          ...
          <Card>
            ...
            <h3 className="text-lg font-bold text-[#3D3C42] mb-2">e-FRRO Registration</h3>
