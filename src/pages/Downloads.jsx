      ...
      {downloadSections.map((section, sectionIdx) => (
        <section key={sectionIdx} className={sectionIdx % 2 === 0 ? '' : 'bg-gray-50'}>
          <div className="max-w-7xl mx-auto px-4 py-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-12">{section.title}</h2>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button className="text-blue-700 hover:text-blue-900 font-semibold text-sm flex items-center gap-1">
                          ⬇️ Download
                        </button>
                      </div>
                    </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card>
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">Visa Application Guide</h3>
          ...
          <Card>
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">Campus Orientation</h3>
          ...
          <Card>
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">e-FRRO Registration</h3>
