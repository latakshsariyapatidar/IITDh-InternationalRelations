        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-brand-marigold">IRO IITDH</h3>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-8 h-8 rounded-full bg-white/10 hover:bg-brand-marigold/20 flex items-center justify-center transition-colors text-brand-purpleLight">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <div className="text-brand-purpleLight/80">
                <span className="text-brand-marigold font-semibold">✉</span> <a href="mailto:iro@iitdh.ac.in" className="hover:text-brand-marigold transition">iro@iitdh.ac.in</a>
              </div>
              <div className="text-brand-purpleLight/80">
                <span className="text-brand-marigold font-semibold">☎</span> +91-836-XXXXXXX
              </div>
            </div>
          </div>
        </div>
